        ...
        <div className="py-16">
          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            <div className="flex flex-wrap justify-center gap-x-6">
              <NavLink href="https://blog.foudroyer.com/legal/legal-notice/">
                <FormattedMessage id="footer/legal-notice" />
              </NavLink>
              <NavLink href="https://blog.foudroyer.com/legal/privacy/">
                <FormattedMessage id="footer/privacy" />
              </NavLink>
              <NavLink href="https://blog.foudroyer.com/legal/terms-of-service/">
