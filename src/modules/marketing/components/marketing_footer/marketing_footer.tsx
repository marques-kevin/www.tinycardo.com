import { languages_with_label } from "@/constants/langs"
        ...
        <div className="flex flex-col items-center border-t border-base-300 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex items-center gap-x-6">
            ...
            >
              <svg
                aria-hidden="true"
                className="h-6 w-6 fill-base-content hover:fill-primary"
                viewBox="0 0 24 24"
              >
          ...
          <p className="mt-6 inline-block text-sm text-base-content sm:mt-0">
            {formatMessage(
              {
                id: "footer/copy",
